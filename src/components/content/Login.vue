    ...
    <div class="login_box">
      ...
      <el-form ref="loginFormRef" class="login_form" :rules="loginFormRules" :model="loginForm">
        ...
        <el-form-item prop="username">
          <el-input v-model="loginForm.username" prefix-icon="iconfonticon-user" placeholder="请输入登录名称"></el-input>
        </el-form-item>
        <!-- 密码 -->
        <el-form-item prop="password">
          <el-input v-model="loginForm.password" prefix-icon="iconfonticon-3702mima" type="password" placeholder="请输入录密码"></el-input>
        </el-form-item>
        <!-- 登录按钮 -->
  ...
  methods: {
    ...
    login () {
      this.$refs.loginFormRef.validate(async valid => {
        ...
        if (res.code !== 100) return this.$message.error('登陆失败，用户名码错误！')
